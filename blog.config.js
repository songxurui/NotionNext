...
const BLOG = {
  AUTHOR: 'Marx Song', // 作者
  BIO: '医学博士，病理医生，业余研究中西方哲学', // 作者简介
  LINK: 'https://www.hipathology.cn', // 网站地址
  AVATAR: '/avatar.png', // 个人头像 默认取public目录下的avatar.png
  KEYWORDS: 'Notion, 博客, 病理', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '66935c3be2814294afe444722d5f0c6c', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '沪ICP备20220422', // 备案号 闽ICP备XXXXXXX
  ...
  CONTACT_EMAIL: 'songxurui@zzc.ac.cn',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/songxurui',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || '37e90b5e-859e-48fe-b437-3d1c6ed3d3b9', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
